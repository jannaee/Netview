...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"routes/shows.js":[function(require,module,exports) {
...
router.get('/:showId/lang/:langId/jsPath/:objectPath',
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            urlPrefix = "http://localhost:3000/data/"; // should parameterize

            language = req.params.langId;
            movieId = req.params.showId;
            objectPath = req.params.objectPath; // make call and pretty print the resulting JSON
...
function getSelectContent(_x4, _x5, _x6, _x7) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _context2.next = 12;
            return jsonpath.query(jsonData, objectPath);
...
var publicDirPath = "./public"; //public path for express engine rendering
...
app.use(express.static(publicDirPath)); // NetView - add middleware

app.use('/shows', showsRouter); // catch 404 and forward to error handler
...
module.exports = app;
},{"./routes/shows":"routes/shows.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
